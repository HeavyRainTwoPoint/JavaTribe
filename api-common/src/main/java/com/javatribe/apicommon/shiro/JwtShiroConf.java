package com.javatribe.apicommon.shiro;



import com.javatribe.apicommon.core.constant.enums.ShiroConstants;
import com.javatribe.apicommon.shiro.filter.JwtFilter;
import com.javatribe.apicommon.shiro.realm.JwtRealm;
...
/**
 * @Author lyr
 * @create 2020/10/25 11:47
 */
@Configuration

public class JwtShiroConf {
    public static final String JWT_FILTER_RULE = "jwt_rule";
    ...
    public DefaultWebSecurityManager defaultWebSecurityManager() {
        ...
        // 使用自定义Realm
        defaultWebSecurityManager.setRealm(jwjtRealm());
        // 关闭Shiro自带的session
